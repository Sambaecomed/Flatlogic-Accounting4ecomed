...
import { create } from '../../stores/reference_transaction_types/reference_transaction_typesSlice';
...
const Reference_transaction_typesNew = () => {
...
Reference_transaction_typesNew.getLayout = function getLayout(
  page: ReactElement,
) {
  return (
    <LayoutAuthenticated permission={'CREATE_REFERENCE_TRANSACTION_TYPES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Reference_transaction_typesNew;
