...
const AccountsTablesPage = () => {
  ...
  const [filters] = useState([
    ...
    { label: 'ParentAccount', title: 'parent_account' },
    { label: 'Organization', title: 'organization' },
    { label: 'Account Group', title: 'account_group' },
  ]);

  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_ACCOUNTS');
