...
import { loadColumns } from './configureReference_party_typesCols';
...
const TableSampleReference_party_types = ({
  filterItems,
  setFilterItems,
  filters,
}) => {
  ...
  const {
    ...
    loading,
    count,
    notify: reference_party_typesNotify,
    refetch,
  } = useAppSelector((state) => state.reference_party_types);
  ...
  useEffect(() => {
    if (reference_party_typesNotify.showNotification) {
      notify(
        reference_party_typesNotify.typeNotification,
        reference_party_typesNotify.textNotification,
      );
    }
  }, [reference_party_typesNotify.showNotification]);
  ...
  const handleEditAction = (id: string) => {
    router.push(`/reference_party_types/${id}`);
  };

  const handleViewAction = (id: string) => {
    router.push(`/reference_party_types/reference_party_types-view/?id=${id}`);
  };
...
export default TableSampleReference_party_types;
