...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/journals/journalsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureJournalsCols';
...
const TableSampleJournals = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (journalsNotify.showNotification) {
      notify(journalsNotify.typeNotification, journalsNotify.textNotification);
    }
  }, [journalsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/journals/journals-view/?id=${id}`);
  };
...
export default TableSampleJournals;
