...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/accounts/accountsSlice';
...
const TableSampleAccounts = ({ filterItems, setFilterItems, filters }) => {
  ...
  const handleViewAction = (id: string) => {
    router.push(`/accounts/accounts-view/?id=${id}`);
  };
