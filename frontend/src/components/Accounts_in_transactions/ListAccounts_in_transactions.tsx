...
const ListAccounts_in_transactions = ({
  ...
  const hasUpdatePermission = hasPermission(
    currentUser,
    'UPDATE_ACCOUNTS_IN_TRANSACTIONS',
  );
  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
        ...
        {!loading &&
          accounts_in_transactions.map((item) => (
        ...
        {!loading && accounts_in_transactions.length === 0 && (
...
export default ListAccounts_in_transactions;
