...
import { loadColumns } from './configureAccounts_in_transactionsCols';
...
const TableSampleAccounts_in_transactions = ({
  filterItems,
  setFilterItems,
  filters,
}) => {
  ...
  const {
    ...
    loading,
    count,
    notify: accounts_in_transactionsNotify,
    refetch,
  } = useAppSelector((state) => state.accounts_in_transactions);
  ...
  useEffect(() => {
    if (accounts_in_transactionsNotify.showNotification) {
      notify(
        accounts_in_transactionsNotify.typeNotification,
        accounts_in_transactionsNotify.textNotification,
      );
    }
  }, [accounts_in_transactionsNotify.showNotification]);
  ...
  const handleEditAction = (id: string) => {
    router.push(`/accounts_in_transactions/${id}`);
  };

  const handleViewAction = (id: string) => {
    router.push(
      `/accounts_in_transactions/accounts_in_transactions-view/?id=${id}`,
    );
  };
...
export default TableSampleAccounts_in_transactions;
