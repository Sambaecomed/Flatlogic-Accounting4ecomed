module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('transactions', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('accounts', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('accounts', 'parent_accountId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('accounts', 'code', { transaction });
