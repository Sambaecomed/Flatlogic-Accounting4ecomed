...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.accounts_organization = await organizations.getAccounts_organization(
      {
        transaction,
      },
    );

    output.transactions_organization =
      await organizations.getTransactions_organization({
        transaction,
      });

    output.general_ledger_organization =
      await organizations.getGeneral_ledger_organization({
        transaction,
      });
